...
Want to showcase your streak on your personal website? We've created a small widget that you can put on your website with two lines of code. It shows up in the bottom right corner. Just replace `username` with you Scrappy username. Here’s the code snippet:
```

...
Hack Clubbers using a Mac can post directly from their menu bar using Scrapple, an app built by <Mention username="linus" />! From the menu bar you are able to type in the update, select the attachments for the post and send it off into the interweb.....

You can download the app [here](https://github.com/LinusS1/Scrapple/releases), it's also [open source](https://github.com/LinusS1/Scrapple)!

Prefer using Homebrew Cask? Run:
